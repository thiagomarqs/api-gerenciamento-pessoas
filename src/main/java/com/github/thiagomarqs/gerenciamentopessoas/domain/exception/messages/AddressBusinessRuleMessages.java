...
public class AddressBusinessRuleMessages {
    ...
    public static final String CANT_REMOVE_MAIN_ADDRESS_WHEN_ONLY_REMAINING_ADDRESS_IS_NOT_ACTIVE = "Can't delete the main address when the only remaining address is inactive. Please activate the other address before deleting this one.";
